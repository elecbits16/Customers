...
#include "C:/Xilinx92i/vhdl/hdp/nt/ieee/numeric_std/numeric_std.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_fsm_test_bench_vhd_behavior(const char*);
        topvh = createWork_fsm_test_bench_vhd_behavior("fsm_test_bench_vhd");
